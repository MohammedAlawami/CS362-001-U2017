...
public class ApptRandomTest {
    ...
    public static String RandomSelectMethod(Random random){
        String[] methodArray = new String[] {"setTitle","setRecurrence","setStartHour","setStartMinute","setStartDay","setStartMonth", "setStartYear", "setDescription"};// The list of the of methods to be tested in the Appt class
			...
			for (int i = 0; i < NUM_TESTS; i++) {
					String methodName = ApptRandomTest.RandomSelectMethod(random);
					   if (methodName.equals("setTitle")){
						 ...
						 int newMinute=(int) ValuesGenerator.getRandomIntBetween(random, -10, 70);
						 appt.setStartMinute(newMinute);
					}
					else if (methodName.equals("setStartDay")){
						int newDay=(int) ValuesGenerator.getRandomIntBetween(random, -10, 60);
						appt.setStartDay(newDay);
				 }
				 else if (methodName.equals("setStartMonth")){
					 int newMonth=(int) ValuesGenerator.getRandomIntBetween(random, -10, 30);
					 appt.setStartMonth(newMonth);
				}
				else if (methodName.equals("setStartYear")){
					int newYear=(int) ValuesGenerator.getRandomIntBetween(random, -10, 3000);
