...
public class CalDayTest {
	 ...
	 @Test
	  public void test01()  throws Throwable  {
			  GregorianCalendar today = new GregorianCalendar(2017,7,13);

				CalDay calen = new CalDay(today);

				assertEquals(13,calen.getDay());  /*bug in getDay it returns the month instead of the day*/
	 ...
	 @Test
	  public void test02()  throws Throwable  {
			...
			assertEquals(3, calen.getSizeAppts()); /*Bug in here, it returns the number of appointments -1 */
			assertEquals(
		 "	 --- 7/7/2017 --- \n" +
		 " --- -------- Appointments ------------ --- \n" +
